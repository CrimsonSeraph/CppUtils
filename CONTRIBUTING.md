# Contributing to CppUtils

感谢你考虑为 CppUtils 贡献代码！我们欢迎任何形式的贡献，包括提交 Bug 报告、功能请求、代码改进、文档更新等。
...
如果你发现了 Bug、有功能建议或对文档有疑问，请在 [GitHub Issues](https://github.com/CrimsonSeraph/CppUtils/issues) 页面提交。
